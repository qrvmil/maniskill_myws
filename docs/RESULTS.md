...
### EXP-000/source-otf-diagnostic-step24524 / COMPLETED / 2026-09-10T00:46:56.600721+00:00
Read-only CPU diagnostic of the archival24524-step main specialist, using the first state of each of48 successful source-base trajectories. This is not an environment evaluation, checkpoint selection, or a modification of the running experiment. CPU isolation asserted; torch2.7.1+cu128, CUDA hidden, wall10.393373910337687s; revision `8bab10e7203f0dc34944ff3fcf85d7274d29e333`, clean. Source spatial taskID2/D0, training seed0; no evaluation seeds/episodes/SR/gain. Checkpoint SHA256 `15f454ba3a7b65730fb51d1d887405973b05642da1b2887834b9fe995c49a7b0`; buffer SHA256 `b5bf1a5286cff1d5a0e18390c59e46349a0e0d88343363071c32819737bc43b1`.

OTF selected actions exactly match independent max-min-Q indexing (max difference0); the base candidate was selected in37/48 sampled comparisons. Mean absolute deterministic physical correction0.016638925218666417, maximum0.02491649240255356, below0.5 bound. Mean Q(base)1.014541642119487, Q(mean edit)1.0147970852752526, Q(sampled edit)1.0101368948817253; actual stored base MC return averages0.26902714371681213. These Q values target a different future policy than the recorded base trajectories, so their difference from base MC returns alone is not a valid calibration-error estimate. The audit does not establish the cause of current active-training failures. Full48 rows, script snapshot, provenance and RNG rule are in diagnostic.json/diagnostic.py. No current hyperparameter or checkpoint choice changed.
